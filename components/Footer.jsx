...
export default function Footer() {
  return (
    // <footer className=" bg-gray-100 justify-center items-center flex py-10">
    ...
    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
      <div className="lg:w-1/3">
        <a href="#" className="flex justify-center space-x-3 lg:justify-start">
          ...
          <span className="self-center text-2xl font-semibold">ETM</span>
        </a>
      </div>
      <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
        <div className="space-y-3">
          <Link href='/about'>
          <h3 className="tracking-wide uppercase text-coolGray-900">About Us</h3>
          </Link>
        ...
        <div className="space-y-3">
          <h3 className="tracking-wide uppercase text-coolGray-900">Address</h3>
          <ul className="space-y-1">
            <li>
            Indrapuri, Patna , Bihar - 800024 </li>

          </ul>
        </div>
        <div className="space-y-3">
          <h3 className="uppercase text-coolGray-900">Contact</h3>
          <ul className="space-y-1">
            <li>
            +91 - 9334977772
            </li>
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-start space-x-3">
            <a href="#" title="Facebook" className="flex items-center p-1">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 fillCurrent">
    ...
    <div className="py-6 text-sm text-center text-coolGray-600">© 2021 Navomesh Stavya India Pvt. Ltd. All rights reserved.</div>
  </footer>
  );
}
